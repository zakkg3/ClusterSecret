...
func init() {
	...
	utilruntime.Must(clustersecretiov1.AddToScheme(scheme))
	utilruntime.Must(clustersecretiov2.AddToScheme(scheme))
...
func main() {
	...
	setupLog.Info("Starting ClusterSecret Operator", "version", version)
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "750ebb96.clustersecret.io",
